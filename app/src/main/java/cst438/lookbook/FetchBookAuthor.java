...
public class FetchBookAuthor extends AsyncTask<String,Void,String>{
    ...
    private static final String LOG_TAG = FetchBookAuthor.class.getSimpleName();

    // Constructor providing a reference to the views in MainActivity
    public FetchBookAuthor(EditText bookInput, ListView lvBook, Context mContext) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            Uri builtURI = Uri.parse(BOOK_BASE_URL).buildUpon()
                    .appendQueryParameter(QUERY_PARAM, queryString+"+inauthor")
                    .appendQueryParameter(MAX_RESULTS, "10")
                    .appendQueryParameter(KEY, "AIzaSyCesd0hp4UBSYJRL0VOny2VbRw3WtDeyro")
                    .build();
