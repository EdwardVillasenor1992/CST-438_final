...
public class SearchBookActivity extends android.support.v7.app.AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        button = (SignInButton) findViewById(R.id.submit_login);
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                .enableAutoManage(this, new GoogleApiClient.OnConnectionFailedListener() {
                    ...
                    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
                        Toast.makeText(SearchBookActivity.this, "something went wrong",Toast.LENGTH_LONG).show();
                    }
                })
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                Toast.makeText(SearchBookActivity.this, "google sign in failed",Toast.LENGTH_LONG).show();
